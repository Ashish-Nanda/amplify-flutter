...
class Amplify {
  ...
  static const APICategory API = const APICategory();
  ...
  Future<void> addPlugin(
      ...
      List<APIPluginInterface> apiPlugins}) {
    if (!_isConfigured) {
      try {
        ...
        if (apiPlugins != null && apiPlugins.length == 1) {
          API.addPlugin(apiPlugins[0]);
        } else if (apiPlugins != null && apiPlugins.length > 1) {
          throw (multiPluginWarning);
        }
      } catch (e) {
        print(e);
